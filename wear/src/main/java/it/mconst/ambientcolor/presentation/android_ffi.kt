   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.ffi_android_ffi_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_android_ffi_rustbuffer_free(buf, status)
        }
    }
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "android_ffi"))
        uniffiCheckContractApiVersion(this)
        uniffiCheckApiChecksums(this)
    }
    external fun uniffi_android_ffi_checksum_func_generate_color_android(
    ): Short
...
internal object UniffiLib {
    ...
    external fun ffi_android_ffi_rust_future_cancel_u8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_i8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_u16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_i16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_u32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_i32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_u64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_i64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_f32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_f64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_rust_buffer(`handle`: Long,
    ): Unit
    ...
    external fun ffi_android_ffi_rust_future_cancel_void(`handle`: Long,
    ): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_android_ffi_uniffi_contract_version()
